...
export default function LoginForm({
  ...
  return (
    <form onSubmit={handleLogin} className="w-full max-w-sm space-y-4 animate-in fade-in duration-200">
      {/* Email */}
      <div>
      ...
      <p className="text-sm text-slate-400 text-center mt-4">
        还没有账号？
        <button type="button" onClick={() => switchMode('register')} className="text-primary font-bold ml-1 hover:underline">
          注册
        </button>
      </p>
    </form>
